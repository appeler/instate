"""Inference-contract metadata for composition-form results.

Implements the common-column block of the appeler inference result contract,
version 1.1 (https://github.com/appeler/appellation). Instate returns
composition-form results: proportions across states or languages that sum to
one, with no predicted label.
"""
...
def metadata_columns(
    ...
    *,
    ...
    return {
        ...
        "uncertainty_level": constant(provenance.uncertainty_level),
    }
