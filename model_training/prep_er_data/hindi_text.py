...
class ReferenceFonts:
    ...
    def __init__(self, paths):
        """Load reference fonts and index their verified shaped outlines."""
    ...
    def decode(self, group, fingerprint):
        """Decode a glyph group while preserving unresolved candidates."""
...
def main():
    """Extract and verify Hindi word renderings from a split archive."""
    import argparse
    import gzip
    import json
    import time
