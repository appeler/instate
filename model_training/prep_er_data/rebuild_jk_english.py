...
def parse(path, reader):
    """Parse one source PDF and retain source-level diagnostics."""
...
def main():
    """Rebuild the searchable English archive into one audited artifact."""
    ...
    with (
        pq.ParquetWriter(artifact, SCHEMA) as writer,
