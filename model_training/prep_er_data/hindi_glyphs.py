...
def usable_unicode(text):
    """Return whether text contains only ASCII or Devanagari characters."""
...
class FontOutlines:
    ...
    def __init__(self, document):
        """Initialize outline caches for an open PDF document."""
        self.document = document
        self.fonts = {}
        self.fingerprints = {}

    def page(self, page):
        """Return unambiguous physical glyph fingerprints for one page."""
...
def build_catalog(paths):
    """Build an outline-to-Unicode catalog from development PDFs."""
    import pymupdf
...
def evaluate_pdf(path, catalog, output):
    """Evaluate catalog recovery on one PDF and write span evidence."""
    import pymupdf
...
def main():
    """Build and evaluate a Mangal outline recovery catalog."""
    import gzip
